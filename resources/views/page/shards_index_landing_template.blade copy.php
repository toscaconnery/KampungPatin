        ...
        <div class="container">
          ...
          <nav class="navbar navbar-expand-lg navbar-dark pt-4 px-0">
            <a class="navbar-brand" href="#">
              <img src="{{url('')}}/shards/images/agency-landing/shards-logo-white.svg" class="mr-2" alt="Shards - Agency Landing Page">
              Shards Agency
            </a>
          ...
          <div class="py-4">
            <div class="row">
              ...
              <div class="col-md-12 col-lg-4">
                <div class="card mb-4">
                  <img class="card-img-top" src="{{url('')}}/shards/images/common/card-1.jpg" alt="Card image cap">
                  <div class="card-body">
              ...
              <div class="col-md-12 col-lg-4">
                <div class="card mb-4">
                  <img class="card-img-top" src="{{url('')}}/shards/images/common/card-3.jpg" alt="Card image cap">
                  <div class="card-body">
              ...
              <div class="col-md-12 col-lg-4">
                <div class="card mb-4">
                  <img class="card-img-top" src="{{url('')}}/shards/images/common/card-2.jpg" alt="Card image cap">
                  <div class="card-body">
