...
<html class="no-js" lang="en">
    ...
    <body class="shards-landing-page--1" >
      ...
      <div id="daftar_produk" class="blog section section-invert py-4">
        <h3 class="section-title text-center m-5">UPR. Graha Pratama Fish</h3>
          ...
          <div class="py-4">
            <div class="row">
              ...
              <div class="col-md-12 col-lg-8">
                <div class="card mb-4">
                  <img class="card-img" src="{{url('')}}/images/crop/salmon_eggs_crop.jpg" alt="Card image cap">
                </div>
              </div>
            ...
            <div class="modal-dialog modal-xl" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title" id="exampleModalLabel">Benih 1 CM</h5>
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                  </button>
                </div>
                <div class="modal-body modal-image">
                    <!-- slkdfjlsdf lsd flskd -->
                  <img class="" style="max-width: 1200px;" src="http://127.0.0.1:8000/images/crop/salmon_eggs_crop.jpg" alt="Card image cap">
                </div>
