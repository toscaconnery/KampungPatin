...
<head>
  ...
  <link rel="stylesheet" href="{{url('')}}/shards/css/shards.min.css?v=2.1.0">
  <!-- <link rel="stylesheet" href="{{url('')}}/shards/css/shards-demo.min.css?v=2.1.0"> -->
  <link rel="stylesheet" href="{{url('')}}/shards/css/shards-demo.css">
</head>
...
<body>
  ...
  <!-- Floating Shards -->
  <img src="{{url('')}}/shards/images/demo/shard-1-5x-3.png" alt="Shard" class="shard">
  <!-- <img src="{{url('')}}/images/logo_tulisan.PNG" alt="Shard" class="shard"> -->

  <!-- Welcome Section -->
  <div class="welcome d-flex justify-content-center flex-column">
    <div class="inner-wrapper mt-auto mb-auto">
      <h1 class="slide-in">Kampung Patin</h1>
        <!-- <img src="{{url('')}}/images/logo_tulisan.PNG" alt="Shard" > -->
      <p class="slide-in">Desa Koto Masjid</p>
        ...
        <div class="icons-example clearfix mb-5">
          <div class="icons-example-wrapper material-icons col-md-6 float-left">
            <div class="material-icons col-lg-3 col-md-3 col-sm-12 d-table text-center ml-auto mr-auto py-5">
              <img class="mb-4" src="{{url('')}}/shards/images/demo/material-icons.svg" alt="Shards supports the Material Icons pack by default.">
          ...
          <div class="icons-example-wrapper font-awesome col-md-6 float-left">
            <div class="material-icons col-lg-3 col-md-3 col-sm-12 d-table text-center mr-auto ml-auto py-5">
              <img class="mb-4" src="{{url('')}}/shards/images/demo/fontawesome-icons.svg" alt="Shards supports the FontAwesome Icons pack by default.">
        ...
        <div class="example col-md-12 ml-auto mr-auto">
          <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
              <div class="card">
                <img class="card-img-top" src="{{url('')}}/shards/images/demo/stock-photos/3.jpg" alt="Card image cap">
                <div class="card-body">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 mb-4 sm-hidden">
              <div class="card">
                <img class="card-img-top" src="{{url('')}}/shards/images/demo/stock-photos/1.jpg" alt="Card image cap">
                <div class="card-body">
                  <h4 class="card-title">Sample Card Title</h4>
                  <p class="card-text">He seems sinking under the evidence could not only grieve and a visit. The father is to bless and placed
                    in his length hid...</p>
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 mb-4 sm-hidden">
              <div class="card">
                <img class="card-img-top" src="{{url('')}}/shards/images/demo/stock-photos/2.jpg" alt="Card image cap">
                <div class="card-body">
                  <h4 class="card-title">Sample Card Title</h4>
                  <p class="card-text">He seems sinking under the evidence could not only grieve and a visit. The father is to bless and placed
                    in his length hid...</p>
    ...
    <div id="navbars" class="my-5">
      ...
      <div class="example">
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary mb-4">
          <img src="{{url('')}}/shards/images/demo/shards-logo.svg" alt="Example Navbar 1" class="mr-2" height="30">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light mb-4">
          <img src="{{url('')}}/shards/images/demo/shards-logo-black.svg" alt="Example Navbar 1" class="mr-2" height="30">
          <a class="navbar-brand" href="#">Shards</a>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4 mb-4 ml-auto">
            <div class="card">
              <img class="card-img-top" src="{{url('')}}/shards/images/demo/shards-app-demo-page-demo.jpg" alt="Shards App Promo - Demo Landing Page">
          ...
          <div class="col-md-4 mb-4 mr-auto">
            <div class="card">
              <img class="card-img-top" src="{{url('')}}/shards/images/demo/shards-agency-landing-page-demo.jpg" alt="Shards Agency - Demo Landing Page">
              <div class="card-body py-3">
  ...
  <script>
    (function (d, s, id) {
      ...
      js.id = id;
      js.src = "{{url('')}}/shards//connect.facebook.net/en_US/sdk.js#xfbml=1&version=v2.10&appId=1662270373824826";
      fjs.parentNode.insertBefore(js, fjs);
    }(document, 'script', 'facebook-jssdk'));

  </script>
  <script async defer src="https://buttons.github.io/buttons.js"></script>
  <script async src="{{url('')}}/shards//platform.twitter.com/widgets.js" charset="utf-8"></script>
  <script src="https://code.jquery.com/jquery-3.3.1.slim.min.js" integrity="sha384-q8i/X+965DzO0rT7abK41JStQIAqVgRVzpbzo5smXKp4YfRvH+8abtTE1Pi6jizo" crossorigin="anonymous"></script>
  <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.3/umd/popper.min.js" integrity="sha384-ZMP7rVo3mIykV+2+9J3UJ46jBk0WLaUAdn689aCwoqbBJiSnjAK/l8WvCWPIPm49" crossorigin="anonymous"></script>
  <script src="https://stackpath.bootstrapcdn.com/bootstrap/4.1.3/js/bootstrap.min.js" integrity="sha384-ChfqqxuZUCnJSK3+MXmPNIyE6ZbWh2IMqE241rYiqJxyMiZ6OW/JmZQ5stwEULTy" crossorigin="anonymous"></script>
  <script src="{{url('')}}/shards/js/shards.min.js"></script>
