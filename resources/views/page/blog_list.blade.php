				...
				<div class="col-md-8 col-lg-9 p-b-80">
					<div class="p-r-45 p-r-0-lg">
						...
						<div class="p-b-63">
							...
							<div class="p-t-32">
								<h4 class="p-b-15">
									<a href="{{url('')}}/blog/{{$b->id}}" class="ltext-108 cl2 hov-cl1 trans-04">
										{{$b->judul}}
									</a>
								</h4>

								<p class="stext-117 cl6" style="text-overflow: ellipsis; white-space: nowrap; overflow: hidden;">
									{{$b->konten}}
								</p>
						...
						<!-- Pagination -->
						{{$blog_list->links('layout.pagination')}}
