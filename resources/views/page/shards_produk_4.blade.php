          ...
          <div class="py-4">
            <div class="row">
              ...
              <div class="col-md-12 col-lg-8">
                <div class="card mb-4">
                  <img class="card-img" src="{{url('')}}/images/crop/ikan_olahan_crop.jpg" alt="Card image cap">
                </div>
              </div>
              ...
              <div class="col-md-12 col-lg-4">
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    <h4 class="card-title">Kaki Naga Ikan</h4>
                    <p class="card-text">Cocok untuk ikan berumur .... He seems sinking under the evidence could not only grieve and a visit. The father is to bless and placed in his length hid...</p>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-12 col-lg-4">
                <div class="card mb-4">
                  <img class="card-img-top" src="{{url('')}}/images/crop/training_center_crop.jpg" alt="Card image cap">
                  <div class="card-body">
                    <h4 class="card-title">Bakso Ikan Goreng</h4>
                    <p class="card-text">Cocok untuk ikan berumur .... He seems sinking under the evidence could not only grieve and a visit. The father is to bless and placed in his length hid...</p>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-12 col-lg-4">
                <div class="card mb-4">
                  <img class="card-img-top" src="{{url('')}}/images/crop/training_center_crop.jpg" alt="Card image cap">
                  <div class="card-body">
                    <h4 class="card-title">Pudung Ikan (Ikan FIllet Asin Patin)</h4>
                    <p class="card-text">Cocok untuk ikan berumur .... He seems sinking under the evidence could not only grieve and a visit. The father is to bless and placed in his length hid...</p>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-12 col-lg-4">
                <div class="card mb-4">
                  <img class="card-img-top" src="{{url('')}}/images/crop/training_center_crop.jpg" alt="Card image cap">
                  <div class="card-body">
                    <h4 class="card-title">Ikan Asap (Salai Patin)</h4>
                    <p class="card-text">Cocok untuk ikan berumur .... He seems sinking under the evidence could not only grieve and a visit. The father is to bless and placed in his length hid...</p>
                  </div>
                </div>
              </div>
