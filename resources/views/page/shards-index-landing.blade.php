            ...
            <div class="row">
              ...
              <div class="col-md-12 col-lg-4">
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    <h4 class="card-title">Pakan Ikan Patin</h4>
                    <p class="card-text">He seems sinking under the evidence could not only grieve and a visit. The father is to bless and placed in his length hid...</p>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-12 col-lg-4">
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    <h4 class="card-title">Budidaya Ikan</h4>
                    <p class="card-text">He seems sinking under the evidence could not only grieve and a visit. The father is to bless and placed in his length hid...</p>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-12 col-lg-4">
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    <h4 class="card-title">Olahan Ikan</h4>
                    <p class="card-text">He seems sinking under the evidence could not only grieve and a visit. The father is to bless and placed in his length hid...</p>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-12 col-lg-4">
                <div class="card mb-4">
                  ...
                  <div class="card-body">
                    <h4 class="card-title">Pusat Pelatihan Perikanan</h4>
                    <p class="card-text">He seems sinking under the evidence could not only grieve and a visit. The father is to bless and placed in his length hid...</p>
                  </div>
                </div>
              </div>
